...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &localstoragev1alpha1.Disk{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func (r *ReconcileDisk) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set Disk instance as the owner and controller
...
func newPodForCR(cr *localstoragev1alpha1.Disk) *corev1.Pod {
